    ...
    public void preguntas(int grado){
        ...
        while(j != 5){
            ...
            if(bandera == false){
                ...
                ventana.preguntona.setText(j + ". " + preguntasInformatica[grado - 1][random]);
                ventana.r1.setText("-1. " + respuestasInformatica[random + ((grado - 1) * (10))][0]);
                ventana.r1.setText("-2. " + respuestasInformatica[random + ((grado - 1) * (10))][1]);
                ventana.r3.setText("-3. " + respuestasInformatica[random + ((grado - 1) * (10))][2]);
                ventana.show();
...
try{
            ...
            JOptionPane.showMessageDialog(null, "tu puntuación fue de: " + puntosInformatica + "/5");
