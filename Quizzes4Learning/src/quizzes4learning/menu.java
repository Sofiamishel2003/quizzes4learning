...
public class menu extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            {
                dispose();
                String[][] consingles = {{"Intenta pensar en el idioma Ingles y no tanto traducir del español", "Pronuncia como te suene bien", "Repite en voz alta las palabras que no conozcas", "Practica mas seguido", "Ponte el chip de modo ingles" , "Crea habitos de estudio", "Realiza en las mañanas tus examenes, asi le puedes preguntar a tu profesor", "Haz un examen todos los dias", "Lee en ingles y las palabras que no conozcas buscalas en tu diccionario", "Recuerda que escuchando tambien puedes practicar, escucha musica en ingles"}};
                String[][] consmate = {{"Practica todos los dias", "Disfruta estudiar matematicas, crea retos para tí mismo", "Ayudate de los examenes", "Usa conceptos", "Intenta usar la lógica ante todo" , "No te quedes con dudas pregunta", "Sigue practicando", "Implementa todo lo que sepas", "Usa tu conocimiento incluso si es de hace años", "Recuerda fórmulas"}};
                String[][] conslite = {{"Practica todos los dias", "Recuerda las relaciones entre las palabras", "Forma tu estilo propio para entender y aplicar", "Habla con todos así no te trabas", "Lee suficiente para ser mas fluido" , "Identifica tema y subtemas", "Busca diferentes perspectivas", "Comparalos con temas anteriores", "Contextualiza", "Estructura el texto"}};
                String[][] conshist = {{"Practica todos los dias", "intenta hacer una linea del tiempo", "Llena los acontecimientos segun su gravedad", "Comprende lo que te enseñan", "Lee sobre lo que te guste de historia" , "Intenta que un acontecimiento te lleve a otro", "El mejor consejo para historia, imagínate que tu estas en el hecho histórico", "Intenta generar historias en tu mente", "Apunta los datos clave", "Haz resumenes sobre lo que entendiste"}};
                String[][] consinfo = {{"Practica todos los dias", "Si tienes una duda intenta resolverla, si no puedes preguntale a tu profesor", "Comparte lo que aprendas con tus amigos", "Intenta otros lenguajes de programacion", "Explora otros caminos" , "Mejora tu método de aprendizaje", "Tomate tus descansos, no todo el dia, pero refresca la mente", "Si te encuentras con un problema busca diferentes maneras de resolverlo", "Persevera", "No pierdas la paciencia"}};
